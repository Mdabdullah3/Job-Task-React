...
const Trusted = () => {
  return (
    <div className="md:mt-48 mt-20 relative text-secondary">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-10/12 md:w-9/12 mx-auto items-center gap-10 mt-10">
        <div className="h-40">
